...
public class PrgSuiviEvalPeriodeRegionViewExcel extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> map, Workbook workbook, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        List<PrgSuiviEvalPeriodeRegionView> paiements = (List<PrgSuiviEvalPeriodeRegionView>)map.get("lesPaiements");
        ...
        for(PrgSuiviEvalPeriodeRegionView paiement : paiements){
