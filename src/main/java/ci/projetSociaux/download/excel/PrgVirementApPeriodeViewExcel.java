...
public class PrgVirementApPeriodeViewExcel extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> map, Workbook workbook, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        List<PrgVirementApPeriodeView> virements = (List<PrgVirementApPeriodeView>)map.get("lesVirementAp");
        ...
        for(PrgVirementApPeriodeView virement : virements){
            ...
            virementRow.createCell(0).setCellValue(virement.getIdVirementAp());
