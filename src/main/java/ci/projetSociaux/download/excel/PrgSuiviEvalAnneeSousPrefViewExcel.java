...
public class PrgSuiviEvalAnneeSousPrefViewExcel extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> map, Workbook workbook, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        List<PrgSuiviEvalAnneeSousPrefView> paiement = (List<PrgSuiviEvalAnneeSousPrefView>)map.get("lesPaiement");
        ...
        for(PrgSuiviEvalAnneeSousPrefView paiements : paiement){
            Row paiementRow =  sheet.createRow(currentRow++);
           
            paiementRow.createCell(0).setCellValue(paiements.getAnneePeriode().intValue());
            ...
            paiementRow.createCell(9).setCellValue(paiements.getMtTotalEmissionFemme().doubleValue());
            paiementRow.createCell(10).setCellValue(paiements.getNbTotalPayeFemme().intValue());
            paiementRow.createCell(11).setCellValue(paiements.getMtTotalPayeFemme().doubleValue());
            paiementRow.createCell(12).setCellValue(paiements.getNbTotalNonPayeFemme().intValue());
            paiementRow.createCell(13).setCellValue(paiements.getMtTotalNonPayeFemme().doubleValue());
            paiementRow.createCell(14).setCellValue(paiements.getNbTotalEmissionHomme().intValue());
            paiementRow.createCell(15).setCellValue(paiements.getMtTotalEmissionHomme().doubleValue());
            paiementRow.createCell(16).setCellValue(paiements.getNbTotalPayeHomme().intValue());
            paiementRow.createCell(17).setCellValue(paiements.getMtTotalPayeHomme().doubleValue());
            paiementRow.createCell(18).setCellValue(paiements.getNbTotalNonPayeHomme().intValue());
            paiementRow.createCell(19).setCellValue(paiements.getMtTotalNonPayeHomme().doubleValue());
