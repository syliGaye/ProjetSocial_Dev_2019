...
public class PrgVirementUgpPeriodeViewPdf extends AbstractPdfView {
    @Override
    protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer, HttpServletRequest request, HttpServletResponse response) throws Exception {

    	
        
    	List<PrgVirementUgpPeriodeView>  virements = (List<PrgVirementUgpPeriodeView>) model.get("lesVirementUgp");
    	
     
        Paragraph tit =new Paragraph("Liste des virements AP");
        ...
        for(PrgVirementUgpPeriodeView virement : virements){
            table.addCell(virement.getIdVirementUgp());
