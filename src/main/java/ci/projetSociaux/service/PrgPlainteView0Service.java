...
import ci.projetSociaux.repository.PrgPlainteView0Repository;
...
@Transactional
@Service
  public class PrgPlainteView0Service {
    
    
	@Autowired
	 PrgPlainteView0Repository  prgPlainteView0Repository;

	public Optional< PrgPlainteNiv0View> findOne(String numPlainte) {
		return  prgPlainteView0Repository.findById(numPlainte);
	}

     public  PrgPlainteNiv0View getOne(String numPlainte) {
		return  prgPlainteView0Repository.getOne(numPlainte);
	}
        
	public List< PrgPlainteNiv0View> findAll() {
		return  prgPlainteView0Repository.findAll();
	}



	public boolean PrgPlainteNiv0ViewExist( PrgPlainteNiv0View  prgPlainteNiv0View){
		return  prgPlainteView0Repository.getOne( prgPlainteNiv0View.getNumPlainte()) != null;
	}
