...
import ci.projetSociaux.repository.PrgPlainteView2Repository;
...
@Transactional
@Service
  public class PrgPlainteView2Service {
    
    
	@Autowired
	 PrgPlainteView2Repository  prgPlainteView2Repository;

	public Optional< PrgPlainteNiv2View> findOne(String numPlainte) {
		return  prgPlainteView2Repository.findById(numPlainte);
	}

     public  PrgPlainteNiv2View getOne(String numPlainte) {
		return  prgPlainteView2Repository.getOne(numPlainte);
	}
        
	public List< PrgPlainteNiv2View> findAll() {
		return  prgPlainteView2Repository.findAll();
	}


    public boolean PrgPlainteNiv2ViewExist( PrgPlainteNiv2View  prgPlainteNiv2View){
		return  prgPlainteView2Repository.getOne( prgPlainteNiv2View.getNumPlainte()) != null;
	}
