 ...
 */
@Entity
@Table(name = "rsu_menage_br_rejet")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "RsuMenageBrRejet.findAll", query = "SELECT r FROM RsuMenageBrRejet r")
    , @NamedQuery(name = "RsuMenageBrRejet.findByOrdre", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.ordre = :ordre")
    , @NamedQuery(name = "RsuMenageBrRejet.findBySubmissiondate", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.submissiondate = :submissiondate")
    , @NamedQuery(name = "RsuMenageBrRejet.findByStarttime", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.starttime = :starttime")
    , @NamedQuery(name = "RsuMenageBrRejet.findByEndtime", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.endtime = :endtime")
    , @NamedQuery(name = "RsuMenageBrRejet.findByDeviceid", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.deviceid = :deviceid")
    , @NamedQuery(name = "RsuMenageBrRejet.findBySubscriberid", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.subscriberid = :subscriberid")
    , @NamedQuery(name = "RsuMenageBrRejet.findBySimid", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.simid = :simid")
    , @NamedQuery(name = "RsuMenageBrRejet.findByDevicephonenum", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.devicephonenum = :devicephonenum")
    , @NamedQuery(name = "RsuMenageBrRejet.findByIlot", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.ilot = :ilot")
    , @NamedQuery(name = "RsuMenageBrRejet.findByBatiment", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.batiment = :batiment")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogement", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logement = :logement")
    , @NamedQuery(name = "RsuMenageBrRejet.findByMenage", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.menage = :menage")
    , @NamedQuery(name = "RsuMenageBrRejet.findByCodeIblm", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.codeIblm = :codeIblm")
    , @NamedQuery(name = "RsuMenageBrRejet.findByConfirmationCodeIblm", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.confirmationCodeIblm = :confirmationCodeIblm")
    , @NamedQuery(name = "RsuMenageBrRejet.findByGpslatitude", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.gpslatitude = :gpslatitude")
    , @NamedQuery(name = "RsuMenageBrRejet.findByGpslongitude", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.gpslongitude = :gpslongitude")
    , @NamedQuery(name = "RsuMenageBrRejet.findByGpsaltitude", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.gpsaltitude = :gpsaltitude")
    , @NamedQuery(name = "RsuMenageBrRejet.findByGpsaccuracy", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.gpsaccuracy = :gpsaccuracy")
    , @NamedQuery(name = "RsuMenageBrRejet.findByChefequipe", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.chefequipe = :chefequipe")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAutreChefequipe", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.autreChefequipe = :autreChefequipe")
    , @NamedQuery(name = "RsuMenageBrRejet.findByEnqueteur", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.enqueteur = :enqueteur")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAutreEnqueteur", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.autreEnqueteur = :autreEnqueteur")
    , @NamedQuery(name = "RsuMenageBrRejet.findByRegiondistrict", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.regiondistrict = :regiondistrict")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAutreRegiondistrict", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.autreRegiondistrict = :autreRegiondistrict")
    , @NamedQuery(name = "RsuMenageBrRejet.findByDepartement", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.departement = :departement")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAutreDepartement", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.autreDepartement = :autreDepartement")
    , @NamedQuery(name = "RsuMenageBrRejet.findBySousprefecture", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.sousprefecture = :sousprefecture")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAutreSousprefecture", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.autreSousprefecture = :autreSousprefecture")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLocalite", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.localite = :localite")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAutreLocalite", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.autreLocalite = :autreLocalite")
    , @NamedQuery(name = "RsuMenageBrRejet.findByQuartierEtVillage", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.quartierEtVillage = :quartierEtVillage")
    , @NamedQuery(name = "RsuMenageBrRejet.findById", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.id = :id")
    , @NamedQuery(name = "RsuMenageBrRejet.findByIdunik", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.idunik = :idunik")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAck", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.ack = :ack")
    , @NamedQuery(name = "RsuMenageBrRejet.findByMilieuResidence", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.milieuResidence = :milieuResidence")
    , @NamedQuery(name = "RsuMenageBrRejet.findByConsent", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.consent = :consent")
    , @NamedQuery(name = "RsuMenageBrRejet.findByRefusNote", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.refusNote = :refusNote")
    , @NamedQuery(name = "RsuMenageBrRejet.findByHhSize", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.hhSize = :hhSize")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogementMur", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logementMur = :logementMur")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogementSol", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logementSol = :logementSol")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogementToit", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logementToit = :logementToit")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogemementChambres", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logemementChambres = :logemementChambres")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogementEau", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logementEau = :logementEau")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogementOrdures", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logementOrdures = :logementOrdures")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogementToilette", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logementToilette = :logementToilette")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLogementDouche", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.logementDouche = :logementDouche")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLTabouret", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.lTabouret = :lTabouret")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLTable", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.lTable = :lTable")
    , @NamedQuery(name = "RsuMenageBrRejet.findByLFauteuil", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.lFauteuil = :lFauteuil")
    , @NamedQuery(name = "RsuMenageBrRejet.findByBienPossede", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.bienPossede = :bienPossede")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAPortable", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aPortable = :aPortable")
    , @NamedQuery(name = "RsuMenageBrRejet.findByATv", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aTv = :aTv")
    , @NamedQuery(name = "RsuMenageBrRejet.findByARadio", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aRadio = :aRadio")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAOrdinateur", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aOrdinateur = :aOrdinateur")
    , @NamedQuery(name = "RsuMenageBrRejet.findByACuisiniere", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aCuisiniere = :aCuisiniere")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAAntenneParabolique", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aAntenneParabolique = :aAntenneParabolique")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAAppareilPhotoNumerique", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aAppareilPhotoNumerique = :aAppareilPhotoNumerique")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAVoiture", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aVoiture = :aVoiture")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAVelomoteur", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aVelomoteur = :aVelomoteur")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAMoto", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aMoto = :aMoto")
    , @NamedQuery(name = "RsuMenageBrRejet.findByABrouette", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aBrouette = :aBrouette")
    , @NamedQuery(name = "RsuMenageBrRejet.findByABateauDePeche", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aBateauDePeche = :aBateauDePeche")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAFerARepasser", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aFerARepasser = :aFerARepasser")
    , @NamedQuery(name = "RsuMenageBrRejet.findByASalonOrdinaire", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aSalonOrdinaire = :aSalonOrdinaire")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAChaiseAutre", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aChaiseAutre = :aChaiseAutre")
    , @NamedQuery(name = "RsuMenageBrRejet.findByALit", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aLit = :aLit")
    , @NamedQuery(name = "RsuMenageBrRejet.findByADrapEtCouverture", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aDrapEtCouverture = :aDrapEtCouverture")
    , @NamedQuery(name = "RsuMenageBrRejet.findByANatte", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aNatte = :aNatte")
    , @NamedQuery(name = "RsuMenageBrRejet.findByASceau", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aSceau = :aSceau")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAPilonEtMortier", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.aPilonEtMortier = :aPilonEtMortier")
    , @NamedQuery(name = "RsuMenageBrRejet.findByDistanceHopital", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.distanceHopital = :distanceHopital")
    , @NamedQuery(name = "RsuMenageBrRejet.findByDistanceCourteLongue", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.distanceCourteLongue = :distanceCourteLongue")
    , @NamedQuery(name = "RsuMenageBrRejet.findByAppelTelephonique", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.appelTelephonique = :appelTelephonique")
    , @NamedQuery(name = "RsuMenageBrRejet.findByMoyenTransfert", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.moyenTransfert = :moyenTransfert")
    , @NamedQuery(name = "RsuMenageBrRejet.findByListFemmes", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.listFemmes = :listFemmes")
    , @NamedQuery(name = "RsuMenageBrRejet.findByNFemmes", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.nFemmes = :nFemmes")
    , @NamedQuery(name = "RsuMenageBrRejet.findByPotentielRecipiendaire", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.potentielRecipiendaire = :potentielRecipiendaire")
    , @NamedQuery(name = "RsuMenageBrRejet.findByRenseignerQuestionnaire", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.renseignerQuestionnaire = :renseignerQuestionnaire")
    , @NamedQuery(name = "RsuMenageBrRejet.findByRemerciementNote", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.remerciementNote = :remerciementNote")
    , @NamedQuery(name = "RsuMenageBrRejet.findByInstanceid", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.instanceid = :instanceid")
    , @NamedQuery(name = "RsuMenageBrRejet.findByInstancename", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.instancename = :instancename")
    , @NamedQuery(name = "RsuMenageBrRejet.findByInstancename2", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.instancename2 = :instancename2")
    , @NamedQuery(name = "RsuMenageBrRejet.findByFormdefVersion", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.formdefVersion = :formdefVersion")
    , @NamedQuery(name = "RsuMenageBrRejet.findByKey", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.key = :key")
    , @NamedQuery(name = "RsuMenageBrRejet.findByIsvalidated", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.isvalidated = :isvalidated")
    , @NamedQuery(name = "RsuMenageBrRejet.findByTypeErreur", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.typeErreur = :typeErreur")
    , @NamedQuery(name = "RsuMenageBrRejet.findByMessageErrBd", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.messageErrBd = :messageErrBd")
    , @NamedQuery(name = "RsuMenageBrRejet.findByCreerPar", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.creerPar = :creerPar")
    , @NamedQuery(name = "RsuMenageBrRejet.findByCreerLe", query = "SELECT r FROM RsuMenageBrRejet r WHERE r.creerLe = :creerLe")})
public class RsuMenageBrRejet implements Serializable {
    ...
    public RsuMenageBrRejet() {
    }

    public RsuMenageBrRejet(String ordre) {
        this.ordre = ordre;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RsuMenageBrRejet)) {
            return false;
        }
        RsuMenageBrRejet other = (RsuMenageBrRejet) object;
    ...
    public String toString() {
        return "ci.projetSociaux.entity.RsuMenageBrRejet[ ordre=" + ordre + " ]";
    }
