 ...
 */
@Entity
@Table(name = "prg_suivi_rsu_menage_mois_view_cumul")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findAll", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByIdSuivi", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.idSuivi = :idSuivi")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByAnnee", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.annee = :annee")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findBycodMois", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.codMois = :codMois")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findBylibelleMois", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.libelleMois = :libelleMois")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenage", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenage = :nbMenage")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByEffTotal", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.effTotal = :effTotal")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByEffHomme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.effHomme = :effHomme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByEffFemme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.effFemme = :effFemme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMemageChefHomme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMemageChefHomme = :nbMemageChefHomme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByEffMembreHomme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.effMembreHomme = :effMembreHomme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByEffHommeFemme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.effHommeFemme = :effHommeFemme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByEffHommeHomme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.effHommeHomme = :effHommeHomme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMemageChefFemme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMemageChefFemme = :nbMemageChefFemme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByEffMembreFemme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.effMembreFemme = :effMembreFemme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbEffFemmeFemme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbEffFemmeFemme = :nbEffFemmeFemme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbEffHommeFemme", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbEffHommeFemme = :nbEffHommeFemme")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenagePauvreModel1", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenagePauvreModel1 = :nbMenagePauvreModel1")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenageRicheModel1", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenageRicheModel1 = :nbMenageRicheModel1")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenagePauvreModel2", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenagePauvreModel2 = :nbMenagePauvreModel2")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenageRicheModel2", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenageRicheModel2 = :nbMenageRicheModel2")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenagePauvreModel3", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenagePauvreModel3 = :nbMenagePauvreModel3")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenageRicheModel3", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenageRicheModel3 = :nbMenageRicheModel3")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenagePauvreModel4", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenagePauvreModel4 = :nbMenagePauvreModel4")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenageRicheModel4", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenageRicheModel4 = :nbMenageRicheModel4")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenagePauvreModel5", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenagePauvreModel5 = :nbMenagePauvreModel5")
    , @NamedQuery(name = "PrgSuiviRsuMenageMoisViewCumul.findByNbMenageRicheModel5", query = "SELECT p FROM PrgSuiviRsuMenageMoisViewCumul p WHERE p.nbMenageRicheModel5 = :nbMenageRicheModel5")})
public class PrgSuiviRsuMenageMoisViewCumul implements Serializable {
    ...
    public PrgSuiviRsuMenageMoisViewCumul() {
    }
