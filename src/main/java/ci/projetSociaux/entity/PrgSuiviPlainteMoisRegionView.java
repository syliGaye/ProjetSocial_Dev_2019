 ...
 */
@Entity
@Table(name = "prg_suivi_plainte_mois_region_view")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findAll", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByIdSuivi", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.idSuivi = :idSuivi")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByAnnee", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.annee = :annee")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByCodMois", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.codMois = :codMois")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByLibelleMois", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.libelleMois = :libelleMois")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByCodRegion", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.codRegion = :codRegion")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNomRegion", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nomRegion = :nomRegion")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainte", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainte = :nbPlainte")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlaintePaiement", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlaintePaiement = :nbPlaintePaiement")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteNonPaiement", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteNonPaiement = :nbPlainteNonPaiement")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteEffFemme", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteEffFemme = :nbPlainteEffFemme")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteEffHomme", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteEffHomme = :nbPlainteEffHomme")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbConfidentiel", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbConfidentiel = :nbConfidentiel")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbNonConfidentiel", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbNonConfidentiel = :nbNonConfidentiel")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteMineur", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteMineur = :nbPlainteMineur")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteMajeur", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteMajeur = :nbPlainteMajeur")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteCiblage", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteCiblage = :nbPlainteCiblage")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteTransfertMonetaire", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteTransfertMonetaire = :nbPlainteTransfertMonetaire")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteMesureAccompagnement", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteMesureAccompagnement = :nbPlainteMesureAccompagnement")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteResolue", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteResolue = :nbPlainteResolue")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByTauxResolutionPlainte", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.tauxResolutionPlainte = :tauxResolutionPlainte")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteCloture", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteCloture = :nbPlainteCloture")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteEnCours", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteEnCours = :nbPlainteEnCours")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteTraitN1", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteTraitN1 = :nbPlainteTraitN1")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteTraitN2", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteTraitN2 = :nbPlainteTraitN2")
    , @NamedQuery(name = "PrgSuiviPlainteMoisRegionView.findByNbPlainteNTraitN3", query = "SELECT p FROM PrgSuiviPlainteMoisRegionView p WHERE p.nbPlainteNTraitN3 = :nbPlainteNTraitN3")})
public class PrgSuiviPlainteMoisRegionView implements Serializable {
    ...
    public PrgSuiviPlainteMoisRegionView() {
    }
