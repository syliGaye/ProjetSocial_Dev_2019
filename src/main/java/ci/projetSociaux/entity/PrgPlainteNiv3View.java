 ...
 */
@Entity
@Table(name = "prg_plainte_niv_3_view")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PrgPlainteNiv3View.findAll", query = "SELECT p FROM PrgPlainteNiv3View p")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodRegion", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codRegion = :codRegion")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByNomRegion", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.nomRegion = :nomRegion")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodDepartement", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codDepartement = :codDepartement")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByNomDepartement", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.nomDepartement = :nomDepartement")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodSPref", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codSPref = :codSPref")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByNomSPref", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.nomSPref = :nomSPref")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodLocalite", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codLocalite = :codLocalite")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByNomLocalite", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.nomLocalite = :nomLocalite")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByNumPlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.numPlainte = :numPlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodePlaignant", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codePlaignant = :codePlaignant")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByFNomPlaingnant", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.fNomPlaingnant = :fNomPlaingnant")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodAgCol", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codAgCol = :codAgCol")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByNomAgCol", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.nomAgCol = :nomAgCol")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDescription", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.description = :description")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodMenage", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codMenage = :codMenage")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByIdPaiement", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.idPaiement = :idPaiement")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateEnregis", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateEnregis = :dateEnregis")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateSignal", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateSignal = :dateSignal")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodTypologie", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codTypologie = :codTypologie")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleTypologie", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleTypologie = :libelleTypologie")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodForeGeste", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codForeGeste = :codForeGeste")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleFormGeste", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleFormGeste = :libelleFormGeste")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodLieu", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codLieu = :codLieu")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleLieu", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleLieu = :libelleLieu")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodModeSaisie", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codModeSaisie = :codModeSaisie")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleModeSaisi", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleModeSaisi = :libelleModeSaisi")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodTypGeste", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codTypGeste = :codTypGeste")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleTyeGeste", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleTyeGeste = :libelleTyeGeste")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodMoment", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codMoment = :codMoment")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleMoment", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleMoment = :libelleMoment")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodObjetDiscr", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codObjetDiscr = :codObjetDiscr")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleObjetDiscr", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleObjetDiscr = :libelleObjetDiscr")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodCatPlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codCatPlainte = :codCatPlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleCatPlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleCatPlainte = :libelleCatPlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodNatGest", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codNatGest = :codNatGest")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibelleNatGest", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libelleNatGest = :libelleNatGest")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByConfidPlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.confidPlainte = :confidPlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibConfidPlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libConfidPlainte = :libConfidPlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateEvent", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateEvent = :dateEvent")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByRefCourrier", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.refCourrier = :refCourrier")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByGravitePlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.gravitePlainte = :gravitePlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibGravitePlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libGravitePlainte = :libGravitePlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByStatutPlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.statutPlainte = :statutPlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByLibStatutPlainte", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.libStatutPlainte = :libStatutPlainte")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodeValid1", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codeValid1 = :codeValid1")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateValid1", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateValid1 = :dateValid1")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateTrans1", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateTrans1 = :dateTrans1")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodeValid2", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codeValid2 = :codeValid2")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateValid2", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateValid2 = :dateValid2")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateTrans2", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateTrans2 = :dateTrans2")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodeValid3", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codeValid3 = :codeValid3")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateValid3", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateValid3 = :dateValid3")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateTrans3", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateTrans3 = :dateTrans3")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByCodeValid4", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.codeValid4 = :codeValid4")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateValid4", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateValid4 = :dateValid4")
    , @NamedQuery(name = "PrgPlainteNiv3View.findByDateCloture", query = "SELECT p FROM PrgPlainteNiv3View p WHERE p.dateCloture = :dateCloture")})
public class PrgPlainteNiv3View implements Serializable {
