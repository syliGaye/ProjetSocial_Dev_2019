 ...
 */
@Entity
@Table(name = "prg_plainte_niv_2_view")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PrgPlainteNiv2View.findAll", query = "SELECT p FROM PrgPlainteNiv2View p")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodRegion", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codRegion = :codRegion")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByNomRegion", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.nomRegion = :nomRegion")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodDepartement", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codDepartement = :codDepartement")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByNomDepartement", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.nomDepartement = :nomDepartement")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodSPref", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codSPref = :codSPref")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByNomSPref", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.nomSPref = :nomSPref")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodLocalite", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codLocalite = :codLocalite")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByNomLocalite", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.nomLocalite = :nomLocalite")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByNumPlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.numPlainte = :numPlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodePlaignant", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codePlaignant = :codePlaignant")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByFNomPlaingnant", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.fNomPlaingnant = :fNomPlaingnant")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodAgCol", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codAgCol = :codAgCol")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByNomAgCol", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.nomAgCol = :nomAgCol")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDescription", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.description = :description")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodMenage", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codMenage = :codMenage")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByIdPaiement", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.idPaiement = :idPaiement")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateEnregis", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateEnregis = :dateEnregis")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateSignal", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateSignal = :dateSignal")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodTypologie", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codTypologie = :codTypologie")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleTypologie", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleTypologie = :libelleTypologie")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodForeGeste", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codForeGeste = :codForeGeste")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleFormGeste", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleFormGeste = :libelleFormGeste")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodLieu", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codLieu = :codLieu")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleLieu", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleLieu = :libelleLieu")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodModeSaisie", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codModeSaisie = :codModeSaisie")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleModeSaisi", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleModeSaisi = :libelleModeSaisi")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodTypGeste", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codTypGeste = :codTypGeste")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleTyeGeste", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleTyeGeste = :libelleTyeGeste")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodMoment", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codMoment = :codMoment")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleMoment", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleMoment = :libelleMoment")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodObjetDiscr", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codObjetDiscr = :codObjetDiscr")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleObjetDiscr", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleObjetDiscr = :libelleObjetDiscr")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodCatPlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codCatPlainte = :codCatPlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleCatPlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleCatPlainte = :libelleCatPlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodNatGest", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codNatGest = :codNatGest")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibelleNatGest", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libelleNatGest = :libelleNatGest")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByConfidPlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.confidPlainte = :confidPlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibConfidPlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libConfidPlainte = :libConfidPlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateEvent", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateEvent = :dateEvent")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByRefCourrier", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.refCourrier = :refCourrier")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByGravitePlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.gravitePlainte = :gravitePlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibGravitePlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libGravitePlainte = :libGravitePlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByStatutPlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.statutPlainte = :statutPlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByLibStatutPlainte", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.libStatutPlainte = :libStatutPlainte")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodeValid1", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codeValid1 = :codeValid1")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateValid1", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateValid1 = :dateValid1")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateTrans1", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateTrans1 = :dateTrans1")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodeValid2", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codeValid2 = :codeValid2")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateValid2", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateValid2 = :dateValid2")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateTrans2", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateTrans2 = :dateTrans2")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodeValid3", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codeValid3 = :codeValid3")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateValid3", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateValid3 = :dateValid3")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateTrans3", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateTrans3 = :dateTrans3")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByCodeValid4", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.codeValid4 = :codeValid4")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateValid4", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateValid4 = :dateValid4")
    , @NamedQuery(name = "PrgPlainteNiv2View.findByDateCloture", query = "SELECT p FROM PrgPlainteNiv2View p WHERE p.dateCloture = :dateCloture")})
public class PrgPlainteNiv2View implements Serializable {
